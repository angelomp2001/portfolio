...
1. **Start a New Experiment**  
   1.1 Switch to main branch: `git switch main`.  
   1.2 Pull the latest version from github: `git pull origin main`.  
...
3. **Conclude Experiment**
   ...
   3.1.6 Update file `experiment_log.md`: add EXPERIMENT_ID, new `Branch_Edit_Summary.md` data, new `RESULTS.md` data.  
