...
## Project Summary
This project trains and evaluates several regression models on a dataset of ~354,000 car listings. The best model is selected based on a chosen metric (RMSE, MAE, MSE, R²) and training/prediction time.
