...
| EXP-004 | experiments/EXP-004-Complete-Checklist | Add Keras NN, 5-fold CV, sklearn Pipelines, PolynomialFeatures, visualizations, multi-metric eval, peak memory tracking, model saving | 🟡 | — |
